...
`astrbot_plugin_Qwen3-tts` 基于本地部署的Qwen3-tts模型将 AstrBot 文本输出转换为语音输出，支持自定义音色、语音分段。
...
在 AstrBot 插件市场搜索 `astrbot_plugin_Qwen3-tts` 并安装。
